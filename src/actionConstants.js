...
// TandaPay action constants
export const TANDAPAY_SETTINGS_UPDATE: 'TANDAPAY_SETTINGS_UPDATE' = 'TANDAPAY_SETTINGS_UPDATE';
export const TANDAPAY_TOKEN_SELECT: 'TANDAPAY_TOKEN_SELECT' = 'TANDAPAY_TOKEN_SELECT';
export const TANDAPAY_TOKEN_ADD_CUSTOM: 'TANDAPAY_TOKEN_ADD_CUSTOM' = 'TANDAPAY_TOKEN_ADD_CUSTOM';
export const TANDAPAY_TOKEN_REMOVE_CUSTOM: 'TANDAPAY_TOKEN_REMOVE_CUSTOM' = 'TANDAPAY_TOKEN_REMOVE_CUSTOM';
export const TANDAPAY_TOKEN_UPDATE_BALANCE: 'TANDAPAY_TOKEN_UPDATE_BALANCE' = 'TANDAPAY_TOKEN_UPDATE_BALANCE';
export const TANDAPAY_TOKEN_INVALIDATE_BALANCE: 'TANDAPAY_TOKEN_INVALIDATE_BALANCE' = 'TANDAPAY_TOKEN_INVALIDATE_BALANCE';
export const TANDAPAY_SET_CONTRACT_ADDRESS: 'TANDAPAY_SET_CONTRACT_ADDRESS' = 'TANDAPAY_SET_CONTRACT_ADDRESS';
export const TANDAPAY_UPDATE_NETWORK_PERFORMANCE: 'TANDAPAY_UPDATE_NETWORK_PERFORMANCE' = 'TANDAPAY_UPDATE_NETWORK_PERFORMANCE';
export const TANDAPAY_COMMUNITY_INFO_UPDATE: 'TANDAPAY_COMMUNITY_INFO_UPDATE' = 'TANDAPAY_COMMUNITY_INFO_UPDATE';
export const TANDAPAY_COMMUNITY_INFO_LOADING: 'TANDAPAY_COMMUNITY_INFO_LOADING' = 'TANDAPAY_COMMUNITY_INFO_LOADING';
export const TANDAPAY_COMMUNITY_INFO_ERROR: 'TANDAPAY_COMMUNITY_INFO_ERROR' = 'TANDAPAY_COMMUNITY_INFO_ERROR';
export const TANDAPAY_COMMUNITY_INFO_INVALIDATE: 'TANDAPAY_COMMUNITY_INFO_INVALIDATE' = 'TANDAPAY_COMMUNITY_INFO_INVALIDATE';

// Member Data Actions
export const TANDAPAY_MEMBER_DATA_UPDATE: 'TANDAPAY_MEMBER_DATA_UPDATE' = 'TANDAPAY_MEMBER_DATA_UPDATE';
export const TANDAPAY_MEMBER_DATA_INVALIDATE: 'TANDAPAY_MEMBER_DATA_INVALIDATE' = 'TANDAPAY_MEMBER_DATA_INVALIDATE';

// Subgroup Data Actions
export const TANDAPAY_SUBGROUP_DATA_UPDATE: 'TANDAPAY_SUBGROUP_DATA_UPDATE' = 'TANDAPAY_SUBGROUP_DATA_UPDATE';
export const TANDAPAY_SUBGROUP_DATA_INVALIDATE: 'TANDAPAY_SUBGROUP_DATA_INVALIDATE' = 'TANDAPAY_SUBGROUP_DATA_INVALIDATE';

// TandaPay wallet action constants
export const TANDAPAY_WALLET_SET: 'TANDAPAY_WALLET_SET' = 'TANDAPAY_WALLET_SET';
export const TANDAPAY_WALLET_CLEAR: 'TANDAPAY_WALLET_CLEAR' = 'TANDAPAY_WALLET_CLEAR';
export const TANDAPAY_WALLET_UPDATE_ADDRESS: 'TANDAPAY_WALLET_UPDATE_ADDRESS' = 'TANDAPAY_WALLET_UPDATE_ADDRESS';

// TandaPay Alchemy API key action constants
export const TANDAPAY_ALCHEMY_API_KEY_SET: 'TANDAPAY_ALCHEMY_API_KEY_SET' = 'TANDAPAY_ALCHEMY_API_KEY_SET';
export const TANDAPAY_ALCHEMY_API_KEY_CLEAR: 'TANDAPAY_ALCHEMY_API_KEY_CLEAR' = 'TANDAPAY_ALCHEMY_API_KEY_CLEAR';
